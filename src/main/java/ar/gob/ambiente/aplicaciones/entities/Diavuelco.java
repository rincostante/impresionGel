 ...
 */
@Entity
@Table(name = "diavuelco")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "Diavuelco.findAll", query = "SELECT d FROM Diavuelco d")})
public class Diavuelco implements Serializable {
    ...
    public String toString() {
        return "ar.gob.ambiente.aplicaciones.entities.Diavuelco[ id=" + id + " ]";
    }
